...
def main():
    ...
    if miss32 == 2**31 - 1:
        misses = "invalid"
    print("%-22s%8.1f%10d%12s" % ("32x32", trans32_score, maxscore["trans32"], misses))
    misses = str(miss64)
    if miss64 == 2**31 - 1:
        misses = "invalid"
    print("%-22s%8.1f%10d%12s" % ("64x64", trans64_score, maxscore["trans64"], misses))
    misses = str(miss61)
    if miss61 == 2**31 - 1:
        misses = "invalid"
    print("%-22s%8.1f%10d%12s" % ("61x67", trans61_score, maxscore["trans61"], misses))
